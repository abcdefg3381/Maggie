 ...
 * @author danyelf
 */
public class FindPathDemo extends JPanel {
...
*/
	...
	public FindPathDemo() {
		...
		// show graph
		final Layout<String, String> layout = new FRLayout<String, String>(mGraph);
	...
	public class MyVertexFillPaintFunction<String> implements Transformer<String, Paint> {
...
*/
	...
	private void findAllPaths(String start, Set<String> visited, Graph<String, String> path,
			LinkedList<String> currpath) {
	...
	public static void main(String[] s) {
		...
		jf.getContentPane().add(new FindPathDemo());
		jf.pack();
		jf.setVisible(true);
	}
