...
public class RandomNetwork {
	...
	private void draw() {
		...
		ErdosRenyiGenerator<Integer, Integer> gen =
				new ErdosRenyiGenerator<Integer, Integer>(new GraphFactory(),
						new VertexFactory(), new EdgeFactory(), 20, 0.2f);
		Graph randomNetwork = gen.create();
		// create graph viewer
		Layout<Integer, Integer> layout = new CircleLayout<Integer, Integer>(randomNetwork);
		...
		GuiUtils.drawComponentToFile(gv, new File("./image/randomNetwork.png"), "png");
	}
